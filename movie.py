...
.title { text-align: center; font-size: 36px !important; font-weight: 700 !important; color: #38bdf8 !important; margin-bottom: 0.5rem !important; }
.subtitle { text-align: center; color: #cbd5f5 !important; font-size: 1.1rem !important; margin-bottom: 2rem !important; }
.result-positive {
...
with st.container(border=True):
    ...
    review_input = st.text_area(
        ...
        height=150,
        placeholder="e.g., This movie was a masterpiece! The performances were incredible and the ending left me speechless..."
    )
