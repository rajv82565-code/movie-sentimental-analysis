...
.title { text-align: center; font-size: 36px; font-weight: 700; color: #38bdf8; margin-bottom: 5px; }
.subtitle { text-align: center; color: #e2e8f0; font-size: 18px; margin-bottom: 20px; }
